...
lazy val root = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      ("io.getquill" %% "quill-core-portable" % "3.6.0-RC3").withDottyCompat(scalaVersion.value),
      ("io.getquill" %% "quill-sql-portable" % "3.6.0-RC3").withDottyCompat(scalaVersion.value),
